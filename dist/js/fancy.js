...
+function($) {
  ...
  Validate.MESSAGES = {
    ...
    'equal' : '"{alias}"输入值与"{parma1}"不匹配！',
    'match' : '"{alias}"输入值与"{parma1}"不匹配！',
    'min' : '"{alias}"输入值必须大于"{parma1}"',
    'max' : '"{alias}"输入值必须小于"{parma1}"',
    'between' : 'The value must be between {parma1} and {param2}',
    'length_min' : '"{alias}"的输入值长度必须大于"{parma1}"',
    'length_max' : '"{alias}"的输入值长度必须小于"{parma1}"',
    'length_between' : 'The length of the value must be between {parma1} and {param2}'
  }
